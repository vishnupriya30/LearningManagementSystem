<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    import="com.dto.Quiz" import="com.dao.QuizDao" import="com.dto.User" import="com.dto.Class"
%>
...
<div class="container-fluid">
      ...
      %>
       ...
       <h3 style=" font-family: 'Alegreya', serif;color:white;text-shadow:2px 2px #3a7bd5">Options</h3>
        ...
        for(int j = 0 ; j < allOptions.length ; j++) {
         ...
         %>
             <p style=" font-family: 'Alegreya', serif;font-size:20px;color:#75FD75"><%=(opt)+". "+optionName%></p>
        <%}
        	 else{
        %>
  ...
  <div class="row">
    ...
    <%User user = (User)session.getAttribute("user");
      ...
      if(user.getUserId() == classroom.getUserId()){
     %>
     <br><a href="TeacherQuiz.jsp"><input type="submit" value="Back"></a>
     <%
      }else{%>
       <br><a href="MissedQuiz.jsp"><input type="submit" value="Back"></a>
       <%} %>
    </div>
