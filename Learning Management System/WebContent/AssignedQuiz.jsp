...
<%
	for(Quiz q : quiz){
		...
		if(!submittedQuizId.contains(q.getQuizId()) && (scheduledTime.compareTo(currentDateTime) > 0)){
%>
<tr>
<td>
<div style="background-color:white;box-shadow: 3px 3px lightgrey; width:600px;height:80px;margin-top:10px;padding-top:-600px;margin-left:250px;border-radius:10px;border:1px solid grey">
 ...
 <a href="StudentExam.jsp?quizId=<%=q.getQuizId()%>" style="text-decoration:none"><h2 style="margin-top:10px; margin-left:8px;color:#3a7bd5;font-family: 'Alegreya', serif;"><%=q.getQuizName()%></h2></a>
</div>
</td>
</tr>
<%}}}
