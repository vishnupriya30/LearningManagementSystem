...
<%List<Correction> correction = CorrectionDao.getSubmittedQuizAfterCorrection(userId,classId,quiz.get(i).getQuizId());
if(correction.size() == 0){
%>
<td>Not Attemped</td>
<%} else { %>
<td><%=correction.get(0).getMarks()%></td>
<%}%>
<%List<Questions> questions = QuestionsDao.getQuestionsByQuizId(quiz.get(i).getQuizId());%>
<td><%=(questions.size()*10)%></td>
</tr>
<%} %>
</table>
</div>
