...
<div style="width:60%;background-color:#3a7bd5;height:55px;border-style:solid;border-radius:3px;border-color:white;margin-left:250px;margin-top:10px">
  <center style="margin-top:10px;font-size:30px;color:white;font-family: 'Alegreya', serif; color:white;text-shadow:2px 2px #3a7bd5;">ASSIGNMENTS</center>
   ...
   <button style="background-color:white;border-radius:10px;border-color:#3a7bd5;height:50px;width:200px;font-size:20px;margin-left:1200px;margin-top:-610px" id = "myBtn" type="submit">Add Assignment</button>
  ...
  <form method="post" action="UploadAssignmentServlet" enctype="multipart/form-data">
     ...
     <tr>
     <td><h3 style="font-family: 'Alegreya', serif;">Scheduled Till :</h3></td>
     <td style="padding-left:15px"><input type="date" name="scheduled"></td>
     </tr>
     </table>
  ...
  <td><a href="Status.jsp?assignmentId=<%=assignments.get(i).getAssignmentId()%>">Check</a></td>
  </tr>
  <%} %>
  </table>
  </div>
